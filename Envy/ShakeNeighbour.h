...
protected:
	BOOL	m_bCanDeflate;			// Envy Settings allow us to send and receive compressed data
	...
	BOOL	m_bG2Send;				// The remote computer is going to send us Gnutella2 packets
									...
									//    Content-Type: application/x-envy
...
protected:
	...
	void SendMinimalHeaders();		// Tell the remote computer we are Envy, and try to setup Gnutella2 communications
