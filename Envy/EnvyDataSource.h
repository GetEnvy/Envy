...
#define CF_ENVY			L"InEnvyDragLoop"
#define CF_ENVY_ALBUMS	L"EnvyAlbums"
#define CF_ENVY_FILES	L"EnvyFiles"

/////////////////////////////////////////////////////////////////////////////
// CEnvyDataSource

class CEnvyDataSource : public CComObject
{
	DECLARE_DYNAMIC(CEnvyDataSource)

public:
	CEnvyDataSource();
	virtual ~CEnvyDataSource();
...
public:
	...
	// Test if object is a Envys drag-n-drop object
	static BOOL IsEnvyObject(IDataObject* pDataObj);
...
//	};
	...
	DECLARE_OLECREATE(CEnvyDataSource)
