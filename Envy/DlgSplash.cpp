...
#define COLOR_DEFAULT		RGB( 202, 185, 156 )
#define COLOR_TEXT			RGB( 244, 240, 230 )
#define COLOR_TEXT_SHADOW	RGB( 174, 150, 102 )
#define COLOR_TEXT_FADE		RGB( 198, 180, 150 )
#define COLOR_BAR_FILL		RGB( 188, 170, 140 )
