...
namespace augment
{
	...
	{
#if defined(_MSC_VER) && (_MSC_VER >= 1600)		// VS2010+ for static_assert, no TR1
		// ToDo: Are these compile-time checks needed?  (Was boost::, std::tr1::is_convertible for VS2008)
		static_assert( std::is_convertible< I0*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I1*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I2*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I3*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I4*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I5*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I6*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I7*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I8*, IUnknown* >::value, "static assert" );
		static_assert( std::is_convertible< I9*, IUnknown* >::value, "static assert" );
#endif
	protected:
