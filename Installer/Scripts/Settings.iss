...
Root: HKCU; Subkey: "Software\Envy\Envy\Skins"; ValueType: dword; ValueName: "Resize\Flags.xml"; ValueData: "{ini:{param:SETTINGS|},Skins,Flags|1}"; Flags: createvalueifdoesntexist uninsdeletekey
