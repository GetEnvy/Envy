...
Source: "Unpacker\Release x64\Unpacker.exe";	DestDir: "{app}"; Flags: overwritereadonly replacesameversion restartreplace uninsremovereadonly sortfilesbyextension ; Check: Install64Bit
Source: "Unpacker\Release Win32\Unpacker.exe";DestDir: "{app}"; Flags: overwritereadonly replacesameversion restartreplace uninsremovereadonly sortfilesbyextension ; Check: not Install64Bit
...
Filename: "{app}\Unpacker.exe"; Parameters: "/installsilent"; WorkingDir: "{app}"; StatusMsg: "{cm:run_skinexe}"
...
Filename: "{app}\Unpacker.exe"; Parameters: "/uninstallsilent"; WorkingDir: "{app}"; StatusMsg: "{cm:run_skinexe}"; RunOnceId: "uninstallskinexe"
...
Root: HKCU; Subkey: "Software\Classes\Applications\Unpacker.exe"; Flags: dontcreatekey uninsdeletekey
