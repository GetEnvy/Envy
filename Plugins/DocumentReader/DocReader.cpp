...
LPCWSTR	CDocReader::uriBook 		= L"http://schemas.getenvy.com/Book.xsd";
LPCWSTR	CDocReader::uriDocument		= L"http://schemas.getenvy.com/Document.xsd";
LPCWSTR	CDocReader::uriSpreadsheet	= L"http://schemas.getenvy.com/Spreadsheet.xsd";
LPCWSTR CDocReader::uriPresentation	= L"http://schemas.getenvy.com/Presentation.xsd";
...
STDMETHODIMP CDocReader::ProcessMSDocument(BSTR bsFile, ISXMLElement* pXML, LPCWSTR pszSchema, LPCWSTR pszFormat)
{
	...
	{
		// Envy will shorten it to 100 characters, so there's nothing we can do
...
STDMETHODIMP CDocReader::GetMSThumbnail(BSTR bsFile, IMAGESERVICEDATA* pParams, SAFEARRAY** ppImage)
{
	...
	*ppImage = SafeArrayCreateVector( VT_UI1, 0, nArray );
	...
	// Unlock safearray; we are ready to deliver it back to Envy
