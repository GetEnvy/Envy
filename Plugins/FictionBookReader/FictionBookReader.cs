...
namespace Envy
{
	...
	// [ProgId("Envy.FictionBookReader")]
	public class FictionBookReader : ILibraryBuilderPlugin, IImageServicePlugin
	{
		static readonly string builderPath = @"SOFTWARE\Envy\Envy\Plugins\LibraryBuilder";
		static readonly string imgServPath = @"SOFTWARE\Envy\Envy\Plugins\ImageService";
		...
		#region Routine of FictionBook XML convertion to Envy format
