...
BEGIN_MESSAGE_MAP(CTorrentToolApp, CWinApp)
	ON_COMMAND(ID_HELP, CTorrentToolApp::OnHelp)
END_MESSAGE_MAP()

CTorrentToolApp theApp;


/////////////////////////////////////////////////////////////////////////////
// CTorrentToolApp construction

CTorrentToolApp::CTorrentToolApp()
{
}

void CTorrentToolApp::OnHelp()
{
//	CWinApp::OnHelp();
	ShellExecute( NULL, NULL, L"http://getenvy.com/wiki/TorrentTool/",
	//	+ static_cast< CWizardPage* >( m_pSheet->GetActivePage() )->GetWindowText(),
		NULL, NULL, SW_SHOWNORMAL );
}

/////////////////////////////////////////////////////////////////////////////
// CTorrentToolApp initialization

BOOL CTorrentToolApp::InitInstance()
{
	...
	else
	{
		...
		HANDLE pMutex = CreateMutex( NULL, FALSE, L"Global\\TorrentTool" );
		if ( GetLastError() == ERROR_ALREADY_EXISTS )
		{
			// Show first instance
			//if ( CWnd* pWnd = CWnd::FindWindow( L"TorrentTool", NULL ) )
			//{
			...
			if ( MessageBox( NULL,
				(LPCWSTR)L"TorrentTool is currently running.\nDo you wish to open a new window?",
				(LPCWSTR)L"Envy TorrentTool",
...
/////////////////////////////////////////////////////////////////////////////
// CTorrentToolApp environment

void CTorrentToolApp::InitEnvironment()
{
	TCHAR szPath[260];
	DWORD dwSize = 0;
...
/////////////////////////////////////////////////////////////////////////////
// CTorrentToolApp resources

void CTorrentToolApp::InitResources()
{
	//OSVERSIONINFO pVersion;
	//pVersion.dwOSVersionInfoSize = sizeof(OSVERSIONINFO);
