...
About using Access. It is very simple. Just open Envy_Schemas.mdb file and you will find window with two buttons: one for entering your translation and the other for generating schemas files.
...
12. Go to the folder where you saved Envy_Schemas.mdb file and you will find Envy subfolder. Here you will find all files that you need to copy to Schemas folder.
