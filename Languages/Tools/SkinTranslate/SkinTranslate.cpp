...
bool CXMLLoader::SavePO(LPCTSTR szFilename) const
{
	...
	sOutput.Format(
		_T("msgid \"\"\n")
		_T("msgstr \"\"\n")
		_T("\"Project-Id-Version: Envy\\n\"\n")
		_T("\"Report-Msgid-Bugs-To: getenvy.com\\n\"\n")
		_T("\"POT-Creation-Date: %s\\n\"\n")
		_T("\"PO-Revision-Date: \\n\"\n")
		_T("\"Last-Translator: %s\\n\"\n")
		_T("\"Language-Team: Envy Development Team\\n\"\n")
		_T("\"MIME-Version: 1.0\\n\"\n")
...
bool CXMLLoader::LoadManifest(IXMLDOMElement* pXMLElement)
{
	...
	//	author=""
	//	updatedBy=""
	//	description="Envy Default English Skin File"
	//	link="http://Envy.sourceforge.net/"
	//	email=""
	//	version="2.4.0.2"
	//	type="Language"
	//	language="en"
