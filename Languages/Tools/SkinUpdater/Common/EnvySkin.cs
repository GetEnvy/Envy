...
{
	[Serializable]
	[XmlType(AnonymousType = true, Namespace = "http://schemas.getenvy.com/Skin.xsd")]
	[XmlRoot(Namespace = "http://www.Envy.com/schemas/Skin.xsd", IsNullable = false)]
	public class skin
	{
		[XmlElement("manifest")]
	...
	[Serializable]
	[XmlType(AnonymousType = true, Namespace = "http://www.Envy.com/schemas/Skin.xsd")]
