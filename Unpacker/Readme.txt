...
1.0.7:
 ...
 - Added right click + "Install Envy Skin" context menu item
 - Maximized state of Envy is preserved when opening options
...
1.0.8
 ...
 - [.1] Envy window is brought to the front on configure or skin apply
